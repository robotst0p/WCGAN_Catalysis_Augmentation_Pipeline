...
sns.scatterplot(data=plot_frame_29999, x="Region", y="Divergence", hue="KL Type", alpha= 1).set(title="KL Divergence Values Across Cingulate Regions 29999 Iterations")
...
def create_region_frame(plot_frame1, plot_frame2, region, new_frame = pd.DataFrame(), new_frame2 = pd.DataFrame()):
...
lh_posterior = create_region_frame(plot_frame_1999, plot_frame_29999, 'ctx_lh_posteriorcingulate')
lh_rostralanterior = create_region_frame(plot_frame_1999, plot_frame_29999, 'ctx_lh_rostralanteriorcingulate')
rh_caudalanterior = create_region_frame(plot_frame_1999, plot_frame_29999, 'ctx_rh_caudalanteriorcingulate')
...
sns.set_style(rc = {'axes.facecolor': sns.color_palette("pastel")[8]})
sns.scatterplot(data=lh_caudalanterior, x="KL Type", y="Divergence", hue='Iteration', alpha= 1, palette='Set2', style = "KL Type", ax=ax1).set(title="LH Caudalanterior Cingulate", xticklabels=[], xlabel = None)
ax1.legend(bbox_to_anchor=(-.74, 1), loc='upper left', borderaxespad=0, fontsize = 7.6)

sns.scatterplot(data=lh_isthmus, x="KL Type", y="Divergence", hue='Iteration', alpha= 1, palette='Set2', style = "KL Type", ax=ax2, legend = False).set(title="LH Isthmus Cingulate", xticklabels=[], xlabel = None)
sns.scatterplot(data=lh_posterior, x="KL Type", y="Divergence", hue='Iteration', alpha= 1, palette='Set2', style = "KL Type", ax=ax3, legend = False).set(title="LH Posterior Cingulate", xticklabels=[], xlabel = None)
sns.scatterplot(data=lh_rostralanterior, x="KL Type", y="Divergence", hue='Iteration', alpha= 1, palette='Set2', style = "KL Type", ax=ax4, legend = False).set(title="LH Rostralanterior Cingulate", xticklabels=[], xlabel = None)
sns.scatterplot(data=rh_caudalanterior, x="KL Type", y="Divergence", hue='Iteration', alpha= 1, palette='Set2', style = "KL Type", ax=ax5, legend = False).set(title="RH Caudalanterior Cingulate", xticklabels=[], xlabel = None)
sns.scatterplot(data=rh_isthmus, x="KL Type", y="Divergence", hue='Iteration', alpha= 1, palette='Set2', style = "KL Type", ax=ax6, legend = False).set(title="RH Isthmus Cingulate", xticklabels=[], xlabel = None)
sns.scatterplot(data=rh_posterior, x="KL Type", y="Divergence", hue='Iteration', alpha= 1, palette='Set2', style = "KL Type", ax=ax7, legend = False).set(title="RH Posterior Cingulate", xticklabels=[], xlabel = None)
sns.scatterplot(data=rh_rostralanterior, x="KL Type", y="Divergence", hue='Iteration', alpha= 1, palette='Set2', style = "KL Type", ax=ax8, legend = False).set(title="RH Rostralanterior Cingulate", xticklabels=[], xlabel = None)
